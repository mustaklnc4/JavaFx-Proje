        ...
        try {
            ...
            if (!getirilen.next())
            {
                ...
                if (txt_ad.getText().equals(""))
                {
                    ...
                    txt_ad.setStyle("-fx-border-color:red");
                }
                else
                {
                    txt_ad.setStyle("-fx-border-color:turquoise");
                }

                if (txt_sifre.getText().equals(""))
                {
                    mesaj+="Şifre Alanı Boş Girdiniz\n";
                    txt_sifre.setStyle("-fx-border-color:red");
                }
                else
                {
                    txt_sifre.setStyle("-fx-border-color:turquoise");
                }

                if (txt_sifre.getText().length()<5)
                {
                    mesaj+="Şifreniz 5 karakterden az olmamalı\n";
                    txt_sifre.setStyle("-fx-border-color:red");
                }
                else
                {
                ...
                {
                    mesaj+="Yetkili Alanı Boş girdiniz!\n";
                    rb_kullanıcı.setStyle("-fx-border-color:red");
                    rb_yönetici.setStyle("-fx-border-color:red");
                }
                else if (rb_yönetici.isSelected())
                {
                    mesaj+="Yetkili Alanı Kontrol Ediniz!\n";
                    rb_kullanıcı.setStyle("-fx-border-color:red");
                    rb_yönetici.setStyle("-fx-border-color:red");
                }
                ...
                {
                    mesaj+="Yetki alanı Yönetice değilse\n";
                    mesaj+="Şifre Veya Kullanıcı Adı Hatalı Olabilir\n";
                    rb_yönetici.setStyle("-fx-border-color:turquoise");
                    rb_kullanıcı.setStyle("-fx-border-color:turquoise");
                    txt_sifre.setStyle("-fx-border-color:red");
                    txt_ad.setStyle("-fx-border-color:red");
                }
